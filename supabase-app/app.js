...
function assetCellHtml(asset, key) {
  ...
  const cells = {
    ...
    new_qr: `<button class="qr-button qr-label" type="button" data-asset-qr="${esc(asset.asset_tag)}" title="Open QR code"><img class="qr" src="${qrCodeUrl(qrText)}" alt="QR"><span>${esc(asset.asset_tag || "")}</span></button>`,
