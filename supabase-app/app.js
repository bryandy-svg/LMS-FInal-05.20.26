...
async function openTruckingDispatchFromRequest(requestNo) {
  ...
  modalBody.innerHTML = `
    ...
    <div class="truck-lines">
      <div class="mini-grid truck-line-head truck-dispatch-head"><strong>Include</strong><strong>Requested Item</strong><strong>Service</strong><strong>Actual Truck / Equipment</strong><strong>Origin</strong><strong>Destination</strong></div>
