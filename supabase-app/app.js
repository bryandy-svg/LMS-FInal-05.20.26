...
async function openTruckingRequestForm(requestNo = "") {
  ...
  modalBody.innerHTML = `
    ...
    <div class="form-grid">
      ...
      <label>Project / Jobsite<input class="suggest-input" name="project_jobsite" list="truckJobsiteOptions" value="${esc(projectJobsite)}" placeholder="Search or enter a new project / jobsite" autocomplete="off" required></label>
