...
const tableMap = {
  ...
  truckingrequests: { table: "trucking_requests", key: "request_no", title: "Move Requests", sub: "Request trucking moves with multiple equipment lines, signature, and dispatch status.", heads: ["request_no", "request_date", "customer", "project", "jobsite", "requested_by", "requestor_email", "needed_date", "status"], labels: ["Request #", "Date", "Customer", "Project", "Jobsite", "Requested By", "Email", "Needed Date", "Status"] },
...
function truckingRequestTable(rows) {
  ...
  return truckingSimpleTable(filtered, ["request_no", "request_date", "customer", "project", "jobsite", "requested_by", "requestor_email", "needed_date", "line_count", "notes"], {
    labels: ["Request #", "Date", "Customer", "Project", "Jobsite", "Requested By", "Email", "Needed Date", "Lines", "Details"],
...
async function openTruckingRequestForm(requestNo = "") {
  ...
  modalBody.innerHTML = `
    ...
    <label>Details of what needs to be done<textarea name="notes">${esc(existing?.notes || "")}</textarea></label>
    ${truckingDatalists()}`;
