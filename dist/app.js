...
if (typeof window !== "undefined") {
  ...
  window.rowMatchesSearch = window.rowMatchesSearch || truckingRowMatchesSearch;
  window.simpleTable = window.simpleTable || truckingSimpleTable;
  window.enhanceSuggestInputs = window.enhanceSuggestInputs || truckingEnhanceSuggestInputs;
}
