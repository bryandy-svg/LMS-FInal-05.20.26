...
with raw(old_account, old_account_code, account, account_code, report_group, type, normal_balance) as (
  ...
  ('Work Order Parts - WIP','12105001','Work Order Parts - WIP','12105001','Balance Sheet','Asset','Debit'),
  ...
  ('Landed Cost Accrual','23010001','Landed Cost Accrual','23010001','Balance Sheet','Liability','Credit'),
