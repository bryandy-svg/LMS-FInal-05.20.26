...
alter table public.equipment_repair_quotes
  ...
  add column if not exists parts_details jsonb not null default '[]'::jsonb,
  add column if not exists labor_details jsonb not null default '[]'::jsonb;
