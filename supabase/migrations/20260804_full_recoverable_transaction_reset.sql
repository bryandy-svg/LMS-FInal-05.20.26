...
--   rentals and other non-fleet operational records.
--
-- PRESERVED:
--   public.assets (including asset IDs and every QR field), app_profiles/auth users,
--   chart_of_accounts, products, customers, vendors, mechanics, warehouses,
...
--   sheet, master terms/settings, accounting periods, beginning balances, and
--   sequences.
--
