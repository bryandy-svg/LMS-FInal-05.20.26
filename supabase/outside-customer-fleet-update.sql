...
alter table outside_customer_fleet add column if not exists plate text;
create index if not exists outside_customer_fleet_plate_idx on outside_customer_fleet (lower(plate));
